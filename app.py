...
from manager_decision_view import render_manager_decision_dashboard
...
def render_manager_view(results_by_intern: dict[str, ScoreResults], default_intern_id: str) -> None:
    render_manager_decision_dashboard(
        results_by_intern=results_by_intern,
        default_intern_id=default_intern_id,
        class_config_loader=load_class_config,
        adjustment_config_loader=load_adjustment_config,
    )
